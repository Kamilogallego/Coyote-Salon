...
const TRANSLATIONS = {
  es: {
    ...
    "sobre.parrafo": "Coyote es una taquería inspirada en las taquerías de calle de Ciudad de México, su estilo se define como Mex-Mex, es decir, realmente mexicano. Es un lugar en el que no tiene cabida la etiqueta. Se disfruta de manera desprevenida con los amigos. Ubicado en el eje cafetero colombiano, se proyecta como una de las cadenas de comida rápida más interesantes del país.",
  ...
  en: {
    ...
    "sobre.titulo": "Taqueria Mex Mex",
    "sobre.parrafo": "Coyote is a taquería inspired by the street taco stands of Mexico City — its style is Mex-Mex, genuinely Mexican. It's a place with no room for pretension, enjoyed without a second thought, with friends. Located in Colombia's coffee region, it's shaping up to be one of the country's most interesting fast-food chains.",
    "sobre.dato2": "Tacos, burritos & micheladas",
